...
try:
	...
	'''
	if (type_thing not in ban_list and random.random() < SAVE_CHANCE) or type_thing == "CSVCMsg_UserMessage": # save all usermessages
			save_packet(stuff.SerializeToString(), count)
			count+= 1
	'''
