...
report='''        1    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap>:1002(_find_and_load)
       ...
       55    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap>:1033(_handle_fromlist)
        ...
        6    0.000    0.000    0.035    0.006 <frozen importlib._bootstrap>:220(_call_with_frames_removed)
       ...
       12    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap_external>:135(_path_stat)
        ...
        3    0.000    0.000    0.036    0.012 <frozen importlib._bootstrap_external>:849(exec_module)
        3    0.000    0.000    0.021    0.007 <frozen importlib._bootstrap_external>:913(source_to_code)
        3    0.000    0.000    0.022    0.007 <frozen importlib._bootstrap_external>:921(get_code)
        6    0.000    0.000    0.000    0.000 <string>:1(<lambda>)
        1    0.000    0.000   28.057   28.057 <string>:1(<module>)
    ...
    88505    0.022    0.000    0.102    0.000 abc.py:100(__subclasscheck__)
    88508    0.021    0.000    0.169    0.000 abc.py:96(__instancecheck__)
      241    0.000    0.000    0.000    0.000 api_implementation.py:136(Type)
     4076    0.001    0.000    0.001    0.000 api_implementation.py:146(IsPythonDefaultSerializationDeterministic)
    12466    0.005    0.000    0.005    0.000 containers.py:192(__init__)
     7802    0.003    0.000    0.003    0.000 containers.py:202(__getitem__)
     2583    0.001    0.000    0.002    0.000 containers.py:206(__len__)
       51    0.000    0.000    0.000    0.000 containers.py:237(__init__)
       51    0.000    0.000    0.000    0.000 containers.py:249(append)
    12415    0.014    0.000    0.020    0.000 containers.py:350(__init__)
    10808    0.032    0.000    0.144    0.000 containers.py:368(add)
     2385    0.006    0.000    0.035    0.000 containers.py:379(extend)
     2385    0.001    0.000    0.037    0.000 containers.py:393(MergeFrom)
    ...
    12522    0.020    0.000    0.023    0.000 decoder.py:117(DecodeVarint)
     4662    0.016    0.000    0.018    0.000 decoder.py:140(DecodeVarint)
    25091    0.030    0.000    0.035    0.000 decoder.py:169(ReadTag)
   ...
   249/58    0.002    0.000    0.027    0.000 decoder.py:601(DecodeRepeatedField)
       25    0.000    0.000    0.002    0.000 decoder.py:623(DecodeField)
     8405    0.009    0.000    0.011    0.000 decoder.py:765(_SkipVarint)
     4606    0.004    0.000    0.010    0.000 decoder.py:785(_SkipLengthDelimited)
       53    0.000    0.000    0.000    0.000 decoder.py:809(_SkipFixed32)
    13064    0.014    0.000    0.037    0.000 decoder.py:838(SkipField)
      430    0.000    0.000    0.000    0.000 descriptor.py:114(__init__)
     7600    0.004    0.000    0.004    0.000 descriptor.py:138(GetOptions)
    ...
    12387    0.013    0.000    0.018    0.000 encoder.py:375(EncodeVarint)
     8814    0.038    0.000    0.056    0.000 encoder.py:391(EncodeSignedVarint)
      488    0.000    0.000    0.001    0.000 encoder.py:409(_VarintBytes)
      488    0.000    0.000    0.002    0.000 encoder.py:418(TagBytes)
      119    0.000    0.000    0.000    0.000 encoder.py:440(SpecificEncoder)
    13891    0.009    0.000    0.075    0.000 encoder.py:462(EncodeField)
...
1737/1320    0.006    0.000    0.122    0.000 encoder.py:757(EncodeRepeatedField)
...
16040/11678    0.030    0.000    0.197    0.000 gen.py:102(_update_independent_generators)
16040/11678    0.013    0.000    0.146    0.000 gen.py:104(<listcomp>)
   202605    0.022    0.000    0.022    0.000 gen.py:15(name)
43709/31413    0.056    0.000    0.210    0.000 gen.py:150(get)
43709/31413    0.101    0.000    0.166    0.000 gen.py:158(<listcomp>)
10202/7602    0.005    0.000    0.107    0.000 gen.py:160(__iter__)
31686/21807    0.030    0.000    1.011    0.000 gen.py:164(__next__)
     1762    0.001    0.000    0.001    0.000 gen.py:19(set_name)
373810/34633    0.309    0.000    0.846    0.000 gen.py:192(step_generator)
   178707    0.094    0.000    0.122    0.000 gen.py:26(__next__)
     4076    0.001    0.000    0.001    0.000 gen.py:36(set_limit)
    23072    0.039    0.000    0.053    0.000 gen.py:44(__init__)
   229638    0.064    0.000    0.155    0.000 gen.py:50(__iter__)
   316926    0.177    0.000    0.351    0.000 gen.py:54(__next__)
   369016    0.057    0.000    0.057    0.000 gen.py:59(get)
     5838    0.017    0.000    0.152    0.000 gen.py:86(__init__)
    28910    0.017    0.000    0.017    0.000 gen.py:9(__init__)
    16040    0.024    0.000    0.050    0.000 gen.py:93(get_independent_generators)
    16040    0.015    0.000    0.025    0.000 gen.py:96(<listcomp>)
     ...
     9911    0.010    0.000    0.112    0.000 message.py:106(CopyFrom)
     4076    0.006    0.000    0.215    0.000 message.py:178(ParseFromString)
    35282    0.006    0.000    0.006    0.000 message_listener.py:77(Modified)
        1    0.001    0.001    0.013    0.013 netmessages_pb2.py:4(<module>)
       50    0.000    0.000    0.000    0.000 netmessages_pb2.py:5(<lambda>)
        1    0.000    0.000    0.000    0.000 network_connection_pb2.py:4(<module>)
    ...
    14245    0.006    0.000    0.006    0.000 pathlib.py:102(join_parsed_parts)
    14247    0.029    0.000    0.249    0.000 pathlib.py:1069(__new__)
    28493    0.009    0.000    0.009    0.000 pathlib.py:1079(_init)
    42609    0.018    0.000    0.018    0.000 pathlib.py:293(splitroot)
    28492    0.119    0.000    0.172    0.000 pathlib.py:64(parse_parts)
    28492    0.074    0.000    0.262    0.000 pathlib.py:672(_parse_args)
    14247    0.024    0.000    0.215    0.000 pathlib.py:692(_from_parts)
    14246    0.014    0.000    0.021    0.000 pathlib.py:705(_from_parsed_parts)
    14245    0.020    0.000    0.027    0.000 pathlib.py:715(_format_parsed_parts)
    14245    0.025    0.000    0.131    0.000 pathlib.py:726(_make_child)
    14246    0.034    0.000    0.061    0.000 pathlib.py:732(__str__)
    14245    0.013    0.000    0.073    0.000 pathlib.py:742(__fspath__)
        1    0.000    0.000    0.000    0.000 pathlib.py:956(joinpath)
    14244    0.010    0.000    0.141    0.000 pathlib.py:964(__truediv__)
        1    0.000    0.000    0.000    0.000 pathlib.py:976(parent)
        3    0.000    0.000    0.063    0.021 pbimport.py:102(from_file)
        3    0.000    0.000    0.000    0.000 pbimport.py:32(find_protoc)
        3    0.000    0.000    0.037    0.012 pbimport.py:60(_load_module)
     ...
     8152    0.006    0.000    0.006    0.000 profiling.py:192(__init__)
     8311    0.006    0.000    0.006    0.000 profiling.py:197(ReadByte)
     8152    0.015    0.000    0.021    0.000 profiling.py:205(ReadVarInt32)
     4076    0.007    0.000    0.023    0.000 profiling.py:221(parse_type)
     4076    0.006    0.000    0.018    0.000 profiling.py:231(parse_length)
     8152    0.012    0.000    0.013    0.000 profiling.py:242(get_length_bytes)
     4076    0.043    0.000   27.057    0.007 profiling.py:261(mutate_message)
     4076    0.002    0.000    0.002    0.000 profiling.py:288(<listcomp>)
     4076    0.078    0.000   27.797    0.007 profiling.py:333(fuzz)
        1    0.000    0.000    0.064    0.064 profiling.py:465(initialize_stuff)
     4076    0.008    0.000    0.122    0.000 profiling.py:472(load_from_file)
        1    0.022    0.022   28.057   28.057 profiling.py:481(main)
5838/4076    0.050    0.000   24.329    0.006 protofuzz.py:123(descriptor_to_generator)
   138240    0.154    0.000    1.111    0.000 protofuzz.py:139(_assign_to_field)
31458/21547    0.115    0.000    1.547    0.000 protofuzz.py:156(_fields_to_object)
     4131    0.004    0.000    0.004    0.000 protofuzz.py:183(__init__)
    25623    0.042    0.000   26.978    0.001 protofuzz.py:188(_iteration_helper)
     4076    0.003    0.000    0.003    0.000 protofuzz.py:228(permute)
        3    0.000    0.000    0.000    0.000 protofuzz.py:237(_module_to_generators)
        3    0.000    0.000    0.000    0.000 protofuzz.py:246(<dictcomp>)
        3    0.000    0.000    0.064    0.021 protofuzz.py:249(from_file)
     4076    0.004    0.000    0.008    0.000 protofuzz.py:291(from_protobuf_class)
    14117    0.053    0.000    1.235    0.000 protofuzz.py:43(_int_generator)
     4630    4.399    0.001   20.805    0.004 protofuzz.py:49(_string_generator)
      265    0.002    0.000    2.002    0.008 protofuzz.py:54(_bytes_generator)
      265    0.954    0.004    1.998    0.008 protofuzz.py:56(<listcomp>)
     1817    0.002    0.000    0.004    0.000 protofuzz.py:60(_float_generator)
       16    0.000    0.000    0.000    0.000 protofuzz.py:64(_enum_generator)
24834/14129    0.069    0.000   24.185    0.002 protofuzz.py:69(_prototype_to_generator)
       62    0.000    0.000    0.000    0.000 python_message.py:1005(_AddByteSizeMethod)
2181/1762    0.012    0.000    0.038    0.000 python_message.py:1008(ByteSize)
       62    0.000    0.000    0.000    0.000 python_message.py:1032(_AddSerializeToStringMethod)
     4076    0.009    0.000    0.281    0.000 python_message.py:1035(SerializeToString)
       62    0.000    0.000    0.000    0.000 python_message.py:1046(_AddSerializePartialToStringMethod)
     4076    0.010    0.000    0.252    0.000 python_message.py:1049(SerializePartialToString)
       62    0.000    0.000    0.001    0.000 python_message.py:105(__new__)
5838/4076    0.037    0.000    0.241    0.000 python_message.py:1055(InternalSerialize)
       62    0.000    0.000    0.000    0.000 python_message.py:1078(_AddMergeFromStringMethod)
     4076    0.007    0.000    0.200    0.000 python_message.py:1080(MergeFromString)
5128/4076    0.047    0.000    0.192    0.000 python_message.py:1100(InternalParse)
...
5838/4076    0.018    0.000    0.020    0.000 python_message.py:1134(IsInitialized)
       62    0.000    0.000    0.000    0.000 python_message.py:1222(_AddMergeFromMethod)
12296/9911    0.045    0.000    0.087    0.000 python_message.py:1226(MergeFrom)
    ...
    13987    0.010    0.000    0.024    0.000 python_message.py:1290(_Clear)
    13348    0.005    0.000    0.005    0.000 python_message.py:1309(_SetListener)
...
62617/62499    0.039    0.000    0.048    0.000 python_message.py:1345(Modified)
       62    0.000    0.000    0.009    0.000 python_message.py:136(__init__)
    48917    0.071    0.000    0.129    0.000 python_message.py:1390(__init__)
    18118    0.005    0.000    0.007    0.000 python_message.py:1409(Modified)
      ...
      238    0.001    0.000    0.004    0.000 python_message.py:274(_AttachFieldHelpers)
    ...
    12415    0.011    0.000    0.031    0.000 python_message.py:410(MakeRepeatedMessageDefault)
       51    0.000    0.000    0.000    0.000 python_message.py:416(MakeRepeatedScalarDefault)
      155    0.000    0.000    0.001    0.000 python_message.py:424(MakeSubMessageDefault)
       62    0.000    0.000    0.000    0.000 python_message.py:451(_AddInitMethod)
    48917    0.274    0.000    0.458    0.000 python_message.py:469(init)
       62    0.000    0.000    0.002    0.000 python_message.py:551(_AddPropertiesForFields)
      237    0.000    0.000    0.002    0.000 python_message.py:562(_AddPropertiesForField)
       10    0.000    0.000    0.000    0.000 python_message.py:587(_AddPropertiesForRepeatedField)
     9832    0.013    0.000    0.043    0.000 python_message.py:604(getter)
      222    0.001    0.000    0.002    0.000 python_message.py:631(_AddPropertiesForNonRepeatedScalarField)
   135878    0.052    0.000    0.072    0.000 python_message.py:649(getter)
   128278    0.099    0.000    0.429    0.000 python_message.py:658(field_setter)
        5    0.000    0.000    0.000    0.000 python_message.py:687(_AddPropertiesForNonRepeatedCompositeField)
      130    0.000    0.000    0.001    0.000 python_message.py:703(getter)
    ...
    35539    0.015    0.000    0.016    0.000 python_message.py:762(_IsPresent)
       62    0.000    0.000    0.000    0.000 python_message.py:774(_AddListFieldsMethod)
     7600    0.016    0.000    0.060    0.000 python_message.py:777(ListFields)
     7600    0.011    0.000    0.027    0.000 python_message.py:778(<listcomp>)
    35539    0.005    0.000    0.005    0.000 python_message.py:779(<lambda>)
     ...
     8152    0.004    0.000    0.005    0.000 python_message.py:935(__eq__)
     ...
     7924    0.010    0.000    0.014    0.000 random.py:238(_randbelow_with_getrandbits)
     4076    0.005    0.000    0.010    0.000 random.py:291(randrange)
     3848    0.005    0.000    0.014    0.000 random.py:344(choice)
       ...
       11    0.000    0.000    0.000    0.000 selectors.py:67(__len__)
        ...
        3    0.000    0.000    0.021    0.007 subprocess.py:1090(communicate)
       14    0.000    0.000    0.000    0.000 subprocess.py:1164(_remaining_time)
        ...
        3    0.000    0.000    0.021    0.007 subprocess.py:1926(_communicate)
    ...
    23973    0.008    0.000    0.029    0.000 type_checkers.py:101(CheckValue)
    78311    0.061    0.000    0.252    0.000 type_checkers.py:129(CheckValue)
        3    0.000    0.000    0.000    0.000 type_checkers.py:150(__init__)
       81    0.000    0.000    0.000    0.000 type_checkers.py:153(CheckValue)
    25964    0.016    0.000    0.022    0.000 type_checkers.py:173(CheckValue)
     ...
     4895    0.003    0.000    0.003    0.000 values.py:123(get_strings)
   133552    0.090    0.000    1.152    0.000 values.py:133(get_integers)
4014/3962    0.013    0.000    0.020    0.000 values.py:151(get_floats)
    14149    0.005    0.000    0.005    0.000 values.py:21(_get_fuzzdb_path)
60973645/60973543   12.279    0.000   17.576    0.000 values.py:72(_limit_helper)
   183521    0.190    0.000    1.063    0.000 values.py:82(_fuzzdb_integers)
 60786110    5.284    0.000    5.296    0.000 values.py:92(_fuzzdb_get_strings)
    ...
    28561    0.012    0.000    0.012    0.000 {built-in method __new__ of type object at 0x956900}
    88508    0.047    0.000    0.148    0.000 {built-in method _abc._abc_instancecheck}
    88505    0.079    0.000    0.080    0.000 {built-in method _abc._abc_subclasscheck}
    ...
    48917    0.045    0.000    0.046    0.000 {built-in method _weakref.proxy}
        3    0.021    0.007    0.021    0.007 {built-in method builtins.compile}
      4/1    0.000    0.000   28.058   28.058 {built-in method builtins.exec}
   142375    0.066    0.000    0.177    0.000 {built-in method builtins.getattr}
       62    0.000    0.000    0.000    0.000 {built-in method builtins.hasattr}
        3    0.000    0.000    0.000    0.000 {built-in method builtins.id}
   882726    0.148    0.000    0.317    0.000 {built-in method builtins.isinstance}
302402/210910    0.108    0.000    0.167    0.000 {built-in method builtins.iter}
278028/277609    0.035    0.000    0.036    0.000 {built-in method builtins.len}
       15    0.000    0.000    0.000    0.000 {built-in method builtins.max}
348615/21810    0.045    0.000    0.842    0.000 {built-in method builtins.next}
    28895    0.004    0.000    0.004    0.000 {built-in method builtins.ord}
    12228    0.115    0.000    0.115    0.000 {built-in method builtins.print}
   128752    0.063    0.000    0.493    0.000 {built-in method builtins.setattr}
        3    0.000    0.000    0.000    0.000 {built-in method builtins.sorted}
        6    0.000    0.000    0.000    0.000 {built-in method io.open_code}
    18294    0.270    0.000    0.343    0.000 {built-in method io.open}
    ...
    14320    0.003    0.000    0.003    0.000 {built-in method posix.fspath}
        3    0.000    0.000    0.000    0.000 {built-in method posix.getpid}
       33    0.002    0.000    0.002    0.000 {built-in method posix.listdir}
    ...
    56741    0.017    0.000    0.017    0.000 {built-in method sys.intern}
       34    0.000    0.000    0.000    0.000 {built-in method time.monotonic}
    14218    0.048    0.000    0.048    0.000 {method '__exit__' of '_io._IOBase' objects}
   ...
   143449    0.021    0.000    0.021    0.000 {method 'append' of 'list' objects}
     7924    0.002    0.000    0.002    0.000 {method 'bit_length' of 'int' objects}
        3    0.000    0.000    0.000    0.000 {method 'clear' of 'dict' objects}
     4082    0.016    0.000    0.016    0.000 {method 'close' of '_io.BufferedReader' objects}
   182144    0.030    0.000    0.030    0.000 {method 'decode' of 'bytes' objects}
        1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
     7279    0.003    0.000    0.003    0.000 {method 'encode' of 'str' objects}
      164    0.000    0.000    0.000    0.000 {method 'endswith' of 'str' objects}
   ...
   173593    0.027    0.000    0.027    0.000 {method 'get' of 'dict' objects}
    12853    0.003    0.000    0.003    0.000 {method 'getrandbits' of '_random.Random' objects}
    ...
    74778    0.044    0.000    0.045    0.000 {method 'items' of 'dict' objects}
      494    0.000    0.000    0.000    0.000 {method 'join' of 'bytes' objects}
    14504    0.008    0.000    0.008    0.000 {method 'join' of 'str' objects}
       16    0.000    0.000    0.000    0.000 {method 'keys' of 'dict' objects}
        3    0.000    0.000    0.000    0.000 {method 'lstrip' of 'str' objects}
    89843    0.013    0.000    0.013    0.000 {method 'pack' of '_struct.Struct' objects}
        8    0.020    0.003    0.020    0.003 {method 'poll' of 'select.poll' objects}
        6    0.000    0.000    0.000    0.000 {method 'pop' of 'collections.deque' objects}
        6    0.000    0.000    0.000    0.000 {method 'pop' of 'dict' objects}
     4079    0.022    0.000    0.022    0.000 {method 'read' of '_io.BufferedReader' objects}
    ...
    28492    0.004    0.000    0.004    0.000 {method 'reverse' of 'list' objects}
    ...
    10236    0.003    0.000    0.003    0.000 {method 'setdefault' of 'dict' objects}
     7600    0.011    0.000    0.016    0.000 {method 'sort' of 'list' objects}
    14126    0.008    0.000    0.008    0.000 {method 'split' of 'str' objects}
    12504    0.002    0.000    0.002    0.000 {method 'startswith' of 'str' objects}
    12707    0.002    0.000    0.002    0.000 {method 'strip' of 'str' objects}
   ...
   123183    0.017    0.000    0.017    0.000 {method 'write' of '_io.BytesIO' objects}
...
if __name__=="__main__":
	...
	for x in lines:
		...
		#print("x == "+str(x))
		#print("x.split(" ") == "+str(x.split(" ")))
		#print(float(x.split(" ")[-5]))
		shit = x.split(" ")
		thing = [oof for oof in shit if oof != ""]
		stuff.append(thing)
	...
	stuff.sort(key=lambda x: float(x[1]), reverse=True)
	for line in stuff:
		print(line)
